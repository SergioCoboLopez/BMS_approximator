...
for n in id_functions:
    ...
    #Read neural network
    #----------------------------------
    nn_path='../../data/nns/nguyen/approximation/' 
    file_name_nn='NN_weights_no_overfit_sigma_%s_rep_%s_r_%s.csv' % (sigma, n, realization)
...
d.to_csv('../../data/nns/nguyen/inter_extrapolation/' + 'NN_no_overfit_inter_extrapolation_sigma_' +str(sigma) + '_r_' + str(realization) + '.csv')
