#26/5/2025
# This code trains a single neural network with all data points.
# The only point of this code is to generate a figure to show what happens when you approximate a
#function generated by an nn with that same nn.
...
#--------------------------------------------------
    for i in range(iterations):
        ...
        yvalid_pred = pyrenn.NNOut(xtrain,net) #Prediction on validation set
...
#Save updated data with model
d.to_csv( output_path + 'NN_no_overfit_test_full_train_' + function + '_sigma_' + str(sigma) + '_r_' + str(realization) + '.csv')
'''
