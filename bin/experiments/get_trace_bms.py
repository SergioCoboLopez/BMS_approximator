...
os.chdir('/export/home/shared/Projects/ANN/Sergio/BMS_approximator/bin/experiments')
...
filename='test_BMS_%s_%s_n_%s_sigma_%s_r_%s_trace_%s_prior_%s.csv' % \
